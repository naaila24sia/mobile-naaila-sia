package com.example.naailaapps.Home.pertemuan_10
...
import com.example.naailaapps.databinding.FragmentTabCBinding

class TabCFragment : Fragment() {
    private var _binding: FragmentTabCBinding? = null // Diperbaiki juga tipe data _binding-nya agar sesuai dengan class binding
